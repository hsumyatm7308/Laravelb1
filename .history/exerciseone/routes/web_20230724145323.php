...
Route::get('staffs/home', [App\Http\Controllers\staffsController::class, 'homemethod'])->name('staffs.home');
// });


Route::get('staffs/home', [staffsController::class, 'homemethod'])->name('staffs.home');
