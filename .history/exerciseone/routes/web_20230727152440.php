...
Route::get('books/read',function(){
    ...
    // $results = DB::table('books')->selectRaw('count(*) AS titlename,title')->where('id',"<>",3)->groupBy('title')->get();
    $results = DB::table('books')->select('count(*) AS titlename,title')->where('id',"<>",3)->groupBy('title')->get();
