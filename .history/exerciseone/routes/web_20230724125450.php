...
Route::get('companystaff', function () {
    $staff = "aung aung"; // Replace with the desired staff name
    $city = "bago"; // Replace with the desired city
    return redirect()->route('companystaffdetails', ['staff' => $staff, 'city' => $city]);
});


Route::get('about/company/{staff}/{city}', function ($staff, $city) {
    return view('aboutcompanystaffbycity', ['sf' => $staff, 'ct' => $city]);
})->name('companystaffdetails');
